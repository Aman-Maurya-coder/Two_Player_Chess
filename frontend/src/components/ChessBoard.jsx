...
import { useGameContext, useGameOptionsContext, useTimerContext } from "../context";
    ...
    function makeAMove(sourceSquare, targetSquare) {
        try {
            ...
            if (result) {
                ...
                console.log("making the move,",movee, "in room :",gameState["gameId"]);
                emitEvent("move", {
                    move: movee,
    ...
    return (
        <div className="board">
            <Chessboard 
                ...
                arePiecesDraggable = {gameState["gameStatus"] === "room full" || gameState["gameStatus"] === "playing"} // Disable dragging when game is over
            />
            <Timer
                socket={socket}
            />
